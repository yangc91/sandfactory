...
(function($, window, document, undefined) {
  ...
  Timepicker.prototype = {
    ...
    getTemplate: function() {
      ...
      if (this.showInputs) {
        hourTemplate = '<input type="text" class="bootstrap-timepicker-hour form-control input-sm" maxlength="2"/>';
        minuteTemplate = '<input type="text" class="bootstrap-timepicker-minute form-control input-sm" maxlength="2"/>';
        secondTemplate = '<input type="text" class="bootstrap-timepicker-second form-control input-sm" maxlength="2"/>';
        meridianTemplate = '<input type="text" class="bootstrap-timepicker-meridian form-control input-sm" maxlength="2"/>';
      } else {
