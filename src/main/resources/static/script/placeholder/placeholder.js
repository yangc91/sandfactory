(function ($) {
    $.fn.placeholder = function (options) {
        ...
        return this.each(function () {
            ...
            var isIE = /msie/.test(navigator.userAgent.toLowerCase());//$.browser.msie,
            version = !$.support.leadingWhitespace ? 8 : 9;//$.browser.version;
