  ...
  Tour = (function() {
    function Tour(options) {
      ...
      this._options = $.extend({
        ...
        duration: false,
        basePath: "",
        template: "<div class='popover'> <div class='arrow'></div> <h3 class='popover-title'></h3> <div class='popover-content'></div> <div class='popover-navigation'> <div class='btn-group'> <button class='btn btn-sm btn-default' data-role='prev'>&laquo; 上一步</button> <button class='btn btn-sm btn-default' data-role='next'>下一步 &raquo;</button> <button class='btn btn-sm btn-default' data-role='pause-resume' data-pause-text='Pause' data-resume-text='Resume'>重新开始</button> </div> <button class='btn btn-sm btn-default' data-role='end'>不再提示</button> </div> </div>",
    ...
    Tour.prototype._scrollIntoView = function(element, callback) {
      ...
      var inDashbordSidebar = $('.dashbord-sidebar ' + element).length > 0 ? true : false;
      var inDashbordMain = $('.dashbord-main ' + element).length > 0 ? true : false;
      var $scrollContainer;
      if(inDashbordSidebar) {
    	  $window = $('.dashbord-sidebar');
    	  $scrollContainer = $window;
      } else if(inDashbordMain) {
    	  $window = $('.dashbord-main');
    	  $scrollContainer = $window;
      } else {
    	  $window = $(window);
...
//      console.log("scrollTop=" + scrollTop);
      ...
      return $scrollContainer.stop(true, true).animate({
        scrollTop: $scrollContainer[0].scrollTop + Math.ceil(scrollTop)
      }, (function(_this) {
      	//周小欠，2014-10-24，修改
        return function() {
    	  callback();
